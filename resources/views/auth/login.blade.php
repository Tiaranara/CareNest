...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .field-wrap input {
            width: 100%;
            background: rgba(30, 86, 255, 0.02);
        ...
        .field-wrap input:focus {
            border-color: #1e56ff;
            background: rgba(30, 86, 255, 0.04);
            box-shadow: 0 0 0 3px rgba(30, 86, 255, 0.15);
        }

        .field-wrap input:focus ~ .fi,
        ...
        @media (max-width: 780px) {
            ...
            .trust-pills { flex-direction: row; flex-wrap: wrap; }
        ...
        @media (max-width: 480px) {
            ...
            .brand-headline { font-size: 1.3rem; }
        }
    </style>
</head>
<body>
...
<div class="page">
    <div class="card">
        ...
        <div class="brand-side">
            <div class="brand-top">
                ...
                <div class="brand-headline">
                    Satu platform,<br>
                    seribu <span>kepedulian</span>
                </div>
                <p class="brand-sub">
                    Sistem informasi manajemen panti asuhan yang membantu pengelolaan data anak, donasi, dan kebutuhan secara real-time dan transparan.
                </p>
        ...
        <div class="form-side">
            ...
            @if ($errors->any())
                <div class="error-box">
                    <strong><i class="fas fa-circle-exclamation"></i> Terjadi kesalahan!</strong>
                    <ul>
            ...
            <p class="foot-link">Belum punya akun? <a href="/register">Daftar sekarang</a></p>
        </div>
